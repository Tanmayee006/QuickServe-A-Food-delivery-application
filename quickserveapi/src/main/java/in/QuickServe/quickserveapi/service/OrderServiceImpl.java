...
import in.QuickServe.quickserveapi.entity.OrderEntity;
import in.QuickServe.quickserveapi.io.OrderRequest;
import in.QuickServe.quickserveapi.io.OrderResponse;
import in.QuickServe.quickserveapi.repository.CartRespository;
import in.QuickServe.quickserveapi.repository.OrderRepository;
...
public OrderResponse createOrderWithPayment(OrderRequest request) throws RazorpayException {
    ...
    RazorpayClient razorpayClient = new RazorpayClient(RAZORPAY_KEY, RAZORPAY_SECRET);
    JSONObject orderRequest = new JSONObject();
    orderRequest.put("amount", newOrder.getAmount() * 100); // paise
    orderRequest.put("currency", "INR");
    orderRequest.put("payment_capture", 1);
    ...
    private OrderResponse convertToResponse(OrderEntity newOrder) {
        return OrderResponse.builder()
                .id(newOrder.getId())
                .amount(newOrder.getAmount() * 100) // return in paise ⚠️
